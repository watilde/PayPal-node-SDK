...
/**
 * Save authorization header with giving data as arguments
 * @param {String} client_id
 * @param {String} access_token
 * @return {undefined}
 */
var saveToken = exports.saveToken = function saveToken(client_id, access_token) {
  var seconds = new Date().getTime() / 1000;
  token_persist[client_id] = access_token;
  token_persist[client_id].created_at = seconds;
}

/**
 * Get token persist to check cache object
 * @return {String} token_persist
 */
var getTokenPersist = exports.getTokenPersist function() {
